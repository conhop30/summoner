...
- Lore and ability descriptions size to their text (`field-sizing: content`) instead of being scroll/resize boxes; the journal stays a fixed box because it is a fixed-height side sheet.
